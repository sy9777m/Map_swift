...
class ViewController: UIViewController, CLLocationManagerDelegate {
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        CLGeocoder().reverseGeocodeLocation(pLocation!, completionHandler: {
            (placemark, error) -> Void in let pm = placemark!.first
    ...
    @IBAction func sgChangeLocation(_ sender: UISegmentedControl) {
        ...
        case 0:
            ...
            break
        case 1:
            setAnnotation(latitudeValue: 37.556876, longitudeValue: 126.914066, delta: 0.1, title: "easy's publishing", subtitle: "서울시 마포구 잔다리로 109 이지스 빌딩")
            self.lblLocationInfo1.text = "Current location"
            self.lblLocationInfo2.text = "easy's publishing"
            break
        case 2:
